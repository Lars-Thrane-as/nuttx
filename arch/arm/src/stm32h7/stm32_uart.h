...
#ifndef CONFIG_UART9_SERIALDRIVER
#  undef CONFIG_UART9_RXDMA
#  undef CONFIG_UART9_TXDMA
#endif

#ifndef CONFIG_USART10_SERIALDRIVER
#  undef CONFIG_USART10_RXDMA
#  undef CONFIG_USART10_TXDMA
#endif
...
#  define SERIAL_HAVE_CONSOLE_TXDMA 1
#elif defined(CONFIG_USART10_SERIAL_CONSOLE) && defined(CONFIG_USART10_TXDMA)
#  define SERIAL_HAVE_CONSOLE_TXDMA 1
#endif
...
#  undef SERIAL_HAVE_ONLY_RXDMA
#elif defined(CONFIG_STM32H7_UART9) && !defined(CONFIG_UART9_RXDMA)
#  undef SERIAL_HAVE_ONLY_RXDMA
#elif defined(CONFIG_STM32H7_USART10) && !defined(CONFIG_USART10_RXDMA)
#  undef SERIAL_HAVE_ONLY_RXDMA
#endif
...
#  undef SERIAL_HAVE_ONLY_TXDMA
#elif defined(CONFIG_STM32H7_UART9) && !defined(CONFIG_UART9_TXDMA)
#  undef SERIAL_HAVE_ONLY_TXDMA
#elif defined(CONFIG_STM32H7_USART10) && !defined(CONFIG_USART10_TXDMA)
#  undef SERIAL_HAVE_ONLY_TXDMA
#endif
...
/* Is RS-485 used? */
    ...
    defined(CONFIG_UART9_RS485)  || defined(CONFIG_USART10_RS485)
#  define HAVE_RS485 1
#endif
