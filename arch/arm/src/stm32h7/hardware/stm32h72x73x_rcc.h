/****************************************************************************
 * arch/arm/src/stm32h7/hardware/stm32h72x73x_rcc.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H7_HARDWARE_STM32H72X73X_RCC_H
#define __ARCH_ARM_SRC_STM32H7_HARDWARE_STM32H72X73X_RCC_H
...
#define RCC_ICSCR_HSITRIM_SHIFT         (24ul)
#define RCC_ICSCR_HSITRIM_MASK          (0x7Ful << RCC_ICSCR_HSITRIM_SHIFT)
#define RCC_ICSCR_HSITRIM               RCC_ICSCR_HSITRIM_MASK /* HSITRIM[30:24] bits */
...
#define RCC_CSICFGR_CSICAL_SHIFT          (0ul)
#define RCC_CSICFGR_CSICAL_MASK           (0x3FFul << RCC_CSICFGR_CSICAL_SHIFT)
#define RCC_CSICFGR_CSICAL                RCC_CSICFGR_CSICAL_MASK  /* CSICAL[9:0] bits */

/* CSITRIM configuration */

#define RCC_CSICFGR_CSITRIM_SHIFT         (24ul)
#define RCC_CSICFGR_CSITRIM_MASK          (0x3Ful << RCC_CSICFGR_CSITRIM_SHIFT)
#define RCC_CSICFGR_CSITRIM               RCC_CSICFGR_CSITRIM_MASK /* CSITRIM[29:24] bits */
...
#  define RCC_D1CCIPR_FMCSEL_PER        (3 << RCC_D1CCIPR_FMCSEL_SHIFT)
                                             /* Bits 2-3: Reserved */
#define RCC_D1CCIPR_OCTOSPISEL_SHIFT    (4)  /* Bits 4-5: */
#define RCC_D1CCIPR_OCTOSPISEL_MASK     (3 << RCC_D1CCIPR_OCTOSPISEL_SHIFT)
#  define RCC_D1CCIPR_OCTOSPISEL_HCLK   (0 << RCC_D1CCIPR_OCTOSPISEL_SHIFT)
#  define RCC_D1CCIPR_OCTOSPISEL_PLL1   (1 << RCC_D1CCIPR_OCTOSPISEL_SHIFT)
#  define RCC_D1CCIPR_OCTOSPISEL_PLL2   (2 << RCC_D1CCIPR_OCTOSPISEL_SHIFT)
#  define RCC_D1CCIPR_OCTOSPISEL_PER    (3 << RCC_D1CCIPR_OCTOSPISEL_SHIFT)
                                             /* Bits 6-15: Reserved */
...
#  define RCC_D2CCIP2R_RNGSEL_PLL1         (1 << RCC_D2CCIP2R_RNGSEL_SHIFT)
#  define RCC_D2CCIP2R_RNGSEL_LSE          (2 << RCC_D2CCIP2R_RNGSEL_SHIFT)
#  define RCC_D2CCIP2R_RNGSEL_LSI          (4 << RCC_D2CCIP2R_RNGSEL_SHIFT)
                                                /* Bits 10-11: Reserved */
...
#  define RCC_D2CCIP2R_LPTIM1SEL_PLL2      (1 << RCC_D2CCIP2R_LPTIM1SEL_SHIFT)
#  define RCC_D2CCIP2R_LPTIM1SEL_PLL3      (2 << RCC_D2CCIP2R_LPTIM1SEL_SHIFT)
...
#  define RCC_D2CCIP2R_LPTIM1SEL_PER       (5 << RCC_D2CCIP2R_LPTIM1SEL_SHIFT)
                                                /* Bit 31: Reserved */
...
#   define RCC_D3CCIPR_SAI4ASEL_SPDIFRX  (5 << RCC_D3CCIPR_SAI4ASEL_SHIFT)
...
#   define RCC_D3CCIPR_SAI4BSEL_SPDIFRX  (5 << RCC_D3CCIPR_SAI4BSEL_SHIFT)
...
#   define RCC_D3CCIPR_SPI6SEL_I2S       (6 << RCC_D3CCIPR_SPI6SEL_SHIFT)
                                              /* Bit 31: Reserved */
...
#define RCC_AHB3RSTR_OCTOSPI1RST        (1 << 14) /* RCC AHB3RSTR: OCTOSPI1RST */
#define RCC_AHB3RSTR_SDMMC1RST          (1 << 16) /* RCC AHB3RSTR: SDMMC1RST */
#define RCC_AHB3RSTR_OCTOSPI2RST        (1 << 19) /* RCC AHB3RSTR: OCTOSPI2RST */
#define RCC_AHB3RSTR_IOMNGRRST          (1 << 21) /* RCC AHB3RSTR: IOMNGRRST */
#define RCC_AHB3RSTR_OTFD1RST           (1 << 22) /* RCC AHB3RSTR: OTFD1RST */
#define RCC_AHB3RSTR_OTFD2RST           (1 << 23) /* RCC AHB3RSTR: OTFD2RST */
...
#define RCC_AHB2RSTR_DCMI_PSSIRS        (1 << 0)  /* RCC AHB2RSTR: DCMI_PSSIRS */
                                                  /* Bits 1-3: Reserved */
...
#define RCC_AHB2RSTR_SDMMC2RST          (1 << 9)  /* RCC AHB2RSTR: SDMMC2RST */
                                                  /* Bits 10-15: Reserved */
#define RCC_AHB2RSTR_FMACRST            (1 << 16) /* RCC AHB2RSTR: FMACRST */
#define RCC_AHB2RSTR_CORDICRST          (1 << 17) /* RCC AHB2RSTR: CORDICRST */
                                                  /* Bits 18-31: Reserved */
...
#define RCC_APB1HRSTR_FDCANRST          (1 << 8)  /* RCC APB1HRSTR: FDCANRST*/
                                                  /* Bits 9-23: Reserved */
#define RCC_APB1HRSTR_TIM23RST          (1 << 24) /* RCC APB1HRSTR: TIM23RST */
#define RCC_APB1HRSTR_TIM24RST          (1 << 25) /* RCC APB1HRSTR: TIM24RST */
                                                  /* Bits 26-31: Reserved */
...
#define RCC_APB2RSTR_UART10RST          (1 << 7)  /* RCC APB2RSTR: UART10RST */
...
#define RCC_APB2RSTR_DFSDM1RST          (1 << 30) /* RCC APB2RSTR: DFSDM1RST */
...
#define RCC_APB4RSTR_DTSRST             (1 << 26) /* RCC APB4RSTR: DTSRST */
...
#define RCC_AHB3ENR_OCTO1EN             (1 << 14) /* RCC AHB3ENR: OCTO1EN */
#define RCC_AHB3ENR_SDMMC1EN            (1 << 16) /* RCC AHB3ENR: SDMMC1EN */
#define RCC_AHB3ENR_OCTO2EN             (1 << 19) /* RCC AHB3ENR: OCTO2EN */
#define RCC_AHB3ENR_IOMNGREN            (1 << 21) /* RCC AHB3ENR: IOMNGREN */
#define RCC_AHB3ENR_OTFD1EN             (1 << 22) /* RCC AHB3ENR: OTFD1EN */
#define RCC_AHB3ENR_OTFD2EN             (1 << 23) /* RCC AHB3ENR: OTFD2EN */
...
#define RCC_AHB2ENR_DCMI_PSSIEN         (1 << 0)  /* RCC AHB2ENR: DCMI_PSSIEN */
...
#define RCC_AHB2ENR_FMACEN              (1 << 16) /* RCC AHB2ENR: FMACEN */
#define RCC_AHB2ENR_CORDICEN            (1 << 17) /* RCC AHB2ENR: CORDICEN */
...
#define RCC_APB1LENR_I2C3EN             (1 << 23) /* RCC APB1LENR: I2C3EN */
                                                  /* Bit 24: Reserved */
#define RCC_APB1LENR_I2C5EN             (1 << 25) /* RCC APB1LENR: I2C5EN */
                                                  /* Bit 26: Reserved */
...
#define RCC_APB1HENR_FDCANEN            (1 << 8)  /* RCC APB1HENR: FDCANEN */
                                                  /* Bits 9-23: Reserved */
#define RCC_APB1HENR_TIM23EN            (1 << 24) /* RCC APB1HENR: TIM23EN */
#define RCC_APB1HENR_TIM24EN            (1 << 25) /* RCC APB1HENR: TIM24EN */
                                                  /* Bits 26-31: Reserved */
...
#define RCC_APB2ENR_SAI1EN              (1 << 22) /* Bit 22: RCC APB2ENR: SAI1EN */
                                                  /* Bits 23-29: Reserved */
#define RCC_APB2ENR_DFSDM1EN            (1 << 30) /* Bit 30: RCC APB2ENR: DFSDM1EN */
                                                  /* Bit 31: Reserved */
...
#define RCC_APB4ENR_SAI4EN              (1 << 21) /* Bit 21: RCC APB4ENR: SAI4EN */
                                                  /* Bits 22-25: Reserved */
#define RCC_APB4ENR_DTSEN               (1 << 26) /* Bit 26: RCC APB4ENR: DTSEN */
                                                  /* Bits 27-31: Reserved */
...
#define RCC_AHB3LPENR_FLASHLPEN         (1 << 8)  /* RCC AHB3LPENR: FLASHLPEN */
#define RCC_AHB3LPENR_FMCLPEN           (1 << 12) /* RCC AHB3LPENR: FMCLPEN */
#define RCC_AHB3LPENR_OCTO1LPEN         (1 << 14) /* RCC AHB3LPENR: OCTO1LPEN */
#define RCC_AHB3LPENR_SDMMC1LPEN        (1 << 16) /* RCC AHB3LPENR: SDMMC1LPEN */
#define RCC_AHB3LPENR_OCTO2LPEN         (1 << 19) /* RCC AHB3LPENR: OCTO2LPEN */
#define RCC_AHB3LPENR_IOMNGRLPEN        (1 << 21) /* RCC AHB3LPENR: IOMNGRLPEN */
#define RCC_AHB3LPENR_OTFD1LPEN         (1 << 22) /* RCC AHB3LPENR: OTFD1LPEN */
#define RCC_AHB3LPENR_OTFD2LPEN         (1 << 23) /* RCC AHB3LPENR: OTFD2LPEN */
#define RCC_AHB3LPENR_D1DTCM1LPEN       (1 << 28) /* RCC AHB3LPENR: D1DTCM1LPEN */
#define RCC_AHB3LPENR_D1DTCM2LPEN       (1 << 29) /* RCC AHB3LPENR: D1DTCM2LPEN */
...
#define RCC_AHB2LPENR_DCMI_PSSILPEN     (1 << 0)  /* RCC AHB2LPENR: DCMI_PSSILPEN */
#define RCC_AHB2LPENR_CRYPTLPEN         (1 << 4)  /* RCC AHB2LPENR: CRYPTLPEN */
#define RCC_AHB2LPENR_HASHLPEN          (1 << 5)  /* RCC AHB2LPENR: HASHLPEN */
#define RCC_AHB2LPENR_RNGLPEN           (1 << 6)  /* RCC AHB2LPENR: RNGLPEN */
#define RCC_AHB2LPENR_SDMMC2LPEN        (1 << 9)  /* RCC AHB2LPENR: SDMMC2LPEN */
#define RCC_AHB2LPENR_FMACLPEN          (1 << 16) /* RCC AHB2LPENR: FMACLPEN */
#define RCC_AHB2LPENR_CORDICLPEN        (1 << 17) /* RCC AHB2LPENR: CORDICLPEN */
...
#define RCC_APB1LLPENR_I2C5LPEN         (1 << 25) /* RCC APB1LLPENR: I2C5LPEN */
#define RCC_APB1LLPENR_HDMICECLPEN      (1 << 27) /* RCC APB1LLPENR: HDMICECLPEN */
#define RCC_APB1LLPENR_DAC12LPEN        (1 << 29) /* RCC APB1LLPENR: DAC12LPEN */
...
#define RCC_APB1HLPENR_TIM23LPEN        (1 << 24) /* RCC APB1HLPENR: TIM23LPEN */
#define RCC_APB1HLPENR_TIM24LPEN        (1 << 25) /* RCC APB1HLPENR: TIM24LPEN */
...
#define RCC_APB2LPENR_UART9LPEN         (1 << 6)  /* RCC APB2LPENR: UART9LPEN */
#define RCC_APB2LPENR_USART10LPEN       (1 << 7)  /* RCC APB2LPENR: USART10LPEN */
...
#define RCC_APB2LPENR_DFSDM1LPEN        (1 << 30) /* RCC APB2LPENR: DFSDM1LPEN */
...
#define RCC_APB4LPENR_DTSLPEN           (1 << 26) /* RCC APB4LPENR: DTSLPEN */

#endif /* __ARCH_ARM_SRC_STM32H7_HARDWARE_STM32H72X73X_RCC_H */
