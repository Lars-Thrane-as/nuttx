/****************************************************************************
 * arch/arm/src/stm32h7/hardware/stm32h72x73x_pwr.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H7_HARDWARE_STM32H72X73X_PWR_H
#define __ARCH_ARM_SRC_STM32H7_HARDWARE_STM32H72X73X_PWR_H
...
#define STM32_PWR_CR3_SMPSEN                (1 << 2)  /* Bit 2: SMPS step-down converter enable */
...
#define STM32_PWR_CR3_VBRS          (1 << 9)    /* Bit 9: VBAT charging resistor selection */
                                                /* Bits 10-15: Reserved */
#ifdef CONFIG_STM32H7_HAVE_SMPS
#define STM32_PWR_CR3_SMPSEXTRDY    (1 << 16)   /* Bit 16: SMPS step-down converter external power supply ready */
#endif
                                                /* Bits 17-23: Reserved */
...
#  define PWR_D3CR_VOS_SCALE_0      (0 << STM32_PWR_D3CR_VOS_SHIFT)
#  define PWR_D3CR_VOS_SCALE_3      (1 << STM32_PWR_D3CR_VOS_SHIFT) /* Default */
#  define PWR_D3CR_VOS_SCALE_2      (2 << STM32_PWR_D3CR_VOS_SHIFT)
#  define PWR_D3CR_VOS_SCALE_1      (3 << STM32_PWR_D3CR_VOS_SHIFT)
                                              /* Bits 16-31: Reserved */
...
#endif /* __ARCH_ARM_SRC_STM32H7_HARDWARE_STM32H72X73X_PWR_H */
