/****************************************************************************
 * arch/arm/src/stm32h7/hardware/stm32h72x73x_flash.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H7_HARDWARE_STM32H72X73X_FLASH_H
#define __ARCH_ARM_SRC_STM32H7_HARDWARE_STM32H72X73X_FLASH_H
...
#define STM32_FLASH_OPTSR2_CUR_OFFSET  0x0070 /* Option status register 2 (CUR) */
#define STM32_FLASH_OPTSR2_PRG_OFFSET  0x0074 /* Option status register 2 (PRG) */
...
#define STM32_FLASH_OPTSR2_CUR         (STM32_FLASHIF_BASE + STM32_FLASH_BANK1_OFFSET + STM32_FLASH_OPTSR2_CUR_OFFSET)
#define STM32_FLASH_OPTSR2_PRG         (STM32_FLASHIF_BASE + STM32_FLASH_BANK1_OFFSET + STM32_FLASH_OPTSR2_PRG_OFFSET)
...
#define FLASH_CR_PSIZE_MASK            (0x3 << FLASH_CR_PSIZE_SHIFT)  /* Used to clear FLASH_CR_PSIZE bits */
#  define FLASH_CR_PSIZE_BYTE          (0 << FLASH_CR_PSIZE_SHIFT)
#  define FLASH_CR_PSIZE_HALFWORD      (1 << FLASH_CR_PSIZE_SHIFT)
#  define FLASH_CR_PSIZE_WORD          (2 << FLASH_CR_PSIZE_SHIFT)
#  define FLASH_CR_PSIZE_DOUBLEWORD    (3 << FLASH_CR_PSIZE_SHIFT)
#define FLASH_CR_FW                    (1 << 6)                       /* Bit 6: Force write */
#define FLASH_CR_START                 (1 << 7)                       /* Bit 7: Erase start */
#define FLASH_CR_SSN_SHIFT             (8)                            /* Bits 8-10: Sector number */
#define FLASH_CR_SSN_MASK              (0x07 << FLASH_CR_SSN_SHIFT)   /* Used to clear FLASH_CR_SSN bits */
#  define FLASH_CR_SSN(n)              ((uint32_t)((n) & 0x07) << FLASH_CR_SSN_SHIFT) /* Sector n, n=0..127 */
...
/* Flash Option Status Register 2 (OPTSR2) */

#define FLASH_OPTSR2_TCMAXI_SHIFT      (0)        /* Bit 0-1: ITCM / AXI memory size */
#define FLASH_OPTSR2_TCMAXI_MASK       (3 << FLASH_OPTSR2_TCMAXI_SHIFT)
#define FLASH_OPTSR2_CPUFREQBOST       (1 << 2)   /* Bit 2: CPU freq boost ability */

#endif /* __ARCH_ARM_SRC_STM32H7_HARDWARE_STM32H72X73X_FLASH_H */
