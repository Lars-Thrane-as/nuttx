/****************************************************************************
 * arch/arm/src/stm32h7/hardware/stm32h72x73x_memorymap.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H7_HARDWARE_STM32H72X73X_MEMORYMAP_H
#define __ARCH_ARM_SRC_STM32H7_HARDWARE_STM32H72X73X_MEMORYMAP_H
...
#define STM32_FMC_BANK1      0x60000000     /* 0x60000000-0x63ffffff:  64Mb NOR/PSRAM/SRAM */
#define STM32_FMC_BANK2      0x64000000     /* 0x64000000-0x67ffffff:  64Mb NOR/PSRAM/SRAM */
#define STM32_FMC_BANK3      0x68000000     /* 0x68000000-0x6Bffffff:  64Mb NOR/PSRAM/SRAM */
#define STM32_FMC_BANK4      0x6c000000     /* 0x6C000000-0x6Fffffff:  64Mb NOR/PSRAM/SRAM */
#define STM32_OCTOSPI2       0x70000000     /* 0x70000000-0x7fffffff: 256Mb OCTOSPI2 */
#define STM32_FMC_NAND       0x80000000     /* 0x80000000-0x8fffffff: 256Mb FMC NAND Flash memory */
#define STM32_OCTOSPI1       0x90000000     /* 0x90000000-0x9fffffff: 256Mb OCTOSPI2 */
...
#define STM32_SRAM2_BASE     0x30004000     /* 0x30040000-0x30007fff: System SRAM2 */
#if 0
#define STM32_SRAM3_BASE     0x3004c000     /* 0x30040000-0x30047fff: System SRAM3 */
#endif
#define STM32_SRAM123_BASE   0x30000000     /* 0x30000000-0x30007fff: System SRAM123 */
#define STM32_SRAM4_BASE     0x38000000     /* 0x38000000-0x38003fff: System SRAM4 */
...
#define STM32_I2C5_BASE        0x40006400     /* 0x40006400-0x400067ff: I2C5 */
...
#define STM32_TIM23_BASE       0x4000e000     /* 0x4000E000 - 0x4000E3FF TIM23 */
#define STM32_TIM24_BASE       0x4000e400     /* 0x4000E400 - 0x4000E7FF TIM24 */
...
#define STM32_DFSDM1_BASE      0x40017800     /* 0x40017800-0x40017fff DFSDM1 */
...
#define STM32_PSSI_BASE        0x48020400     /* 0x48020400-0x480207ff PSSI */
...
#define STM32_RAMECCD2_BASE    0x48023000     /* 0x48023000-0x48023fff RAMECC D2 domain */
#define STM32_FMAC_BASE        0x48024000     /* 0x480243ff-0x480243ff FMAC */
#define STM32_CORDIC_BASE      0x48024400     /* 0x48024400-0x480247ff CORDIC */
...
#define STM32_OCTOSPI1_BASE    0x52005000     /* 0x52005000-0x52005fff OCTOSPI1 control */
#define STM32_DLYBOCTOSPI1_BASE 0x52006000    /* 0x52006000-0x52006fff OCTOSPI1 Delay Block */
...
#define STM32_RAMECCD1_BASE    0x52009000     /* 0x52009000-0x520093ff RAMDECC D1 domain */
#define STM32_OCTOSPI2_BASE    0x5200a000     /* 0x5200a000-0x5200afff OCTOSPI2 control */
#define STM32_DLYBOCTOSPI2_BASE 0x5200b000    /* 0x5200b000-0x5200bfff OCTOSPI2 Delay Block */
#define STM32_OCTOSPIIO_BASE   0x5200b400     /* 0x5200b400-0x5200b7ff OCTOSPI I/O */
#define STM32_OTFDEC1_BASE     0x5200b800     /* 0x5200b800-0x5200bbff OTFDEC1 */
#define STM32_OTFDEC2_BASE     0x5200bc00     /* 0x5200bc00-0x5200bfff OTFDEC1 */
...
#define STM32_SYSMEM_UID       0x1ff1e800     /* Unique device ID 96-bit register */
#define STM32_SYSMEM_FSIZE     0x1ff1e880     /* Flash size 16-bit register */
#define STM32_SYSMEM_LINEID    0x1ff1e8c0     /* Line ID register */
#if 0
#define STM32_SYSMEM_PACKAGE   0x1ff1????     /* Package data register */
#endif
...
#endif /* __ARCH_ARM_SRC_STM32H7_HARDWARE_STM32H72X73X_MEMORYMAP_H */
